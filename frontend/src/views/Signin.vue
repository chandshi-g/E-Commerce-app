      ...
      <div class="col-12 justify-content-center d-flex flex-row pt-5">
        <div id="signin-div" class="flex-item border">
          ...
          <form @submit="signin" class="pt-4 pl-4 pr-4">
            ...
            <small class="form-text text-muted">By continuing, you agree to Ecommerce Conditions of Use and Privacy Notice.</small>
          ...
          <hr>
          <small class="form-text text-muted pt-2 pl-4 text-center">New to Ecommerce?</small>
          <p class="text-center">
            <router-link :to="{name: 'Signup'}" class="btn btn-dark text-center mx-auto px-5 py-1 mb-2">Create Your Ecommerce Account</router-link>
          </p>
        </div>
      </div>
    </div>
