...
export default {
    data(){
        return {
            stripeAPIToken: "pk_test_51TqAoBRxWrb2KmPe7M46HrHSvYzlHom8YgED4QzTLNpWdobSMw8y7RZJ27TqYBKF8egHA4azh7UcfAHF3RlK6nxs00xxqCNr3s",
            stripe: '',
            token:null,
            sessionId:null,
            checkoutBodyArray:[]
    ...
    methods: {
        ...
        // get all cart Items for the user
                ...
                console.log("Checkout Body:", this.checkoutBodyArray);
                    ...
                    axios.post(`${this.baseURL}order/checkout`,
...
ZIP Code: Any valid ZIP (if asked)